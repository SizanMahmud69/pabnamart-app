...
import { ArrowLeft, MoreHorizontal, Eye, Trash2, Loader2, User } from 'lucide-react';
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger, DropdownMenuSub, DropdownMenuSubTrigger, DropdownMenuSubContent, DropdownMenuPortal, DropdownMenuSeparator } from '@/components/ui/dropdown-menu';
import { getFirestore, collection, onSnapshot, query, orderBy, doc, runTransaction, increment } from 'firebase/firestore';
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <DropdownMenu>
                                                            <DropdownMenuTrigger asChild>
                                                                <Button variant="ghost" className="h-8 w-8 p-0" onPointerDown={(e) => e.preventDefault()}>
